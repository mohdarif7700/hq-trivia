...
oot_channel_id_list = ["557047819832393739","525131707410677761","523359669280833536","513818250652680213"]
        ...
        if answer_scores != answer_scores_last:
            if wrong and answer :
                ...
                if not sent_new_message:
                    ...
                    embed=discord.Embed(title="THEQ QLIVE", description="", color=0xadd8e6)
